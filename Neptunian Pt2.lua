...
local username = game:GetService("Workspace").seademon123

--change the catonthewall thing to ur username
--change the catonthewall thing to ur username
--change the catonthewall thing to ur username
--change the catonthewall thing to ur username
...
tl1.Color = ColorSequence.new(BrickColor.new('Gold').Color)
tl1.Lifetime = 0.6
tl1.Enabled = false
...
local wng1a = CreateParta(m,1,0,"Neon",BrickColor.new("Gold"))
...
local wng2a = CreateParta(m,1,0,"Neon",BrickColor.new("Gold"))
...
local wng1b = CreateParta(m,1,0,"Neon",BrickColor.new("Gold"))
...
local wng2b = CreateParta(m,1,0,"Neon",BrickColor.new("Gold"))
...
-- username = "ur user here"


Instance.new("Attachment",username.MeshPartAccessory.Handle)
Instance.new("AlignPosition",username.MeshPartAccessory.Handle)
Instance.new("AlignOrientation",username.MeshPartAccessory.Handle)

username.Model.Name = "m"
username.Model.Name = "Model2"
username.Model2.Part.Name = "Part1"

username.MeshPartAccessory.Handle.AlignPosition.Responsiveness = 200
username.MeshPartAccessory.Handle.AlignOrientation.Responsiveness = 200

username.MeshPartAccessory.Handle.AccessoryWeld:Remove()

username.Model2.Part1.Attachment.Orientation = Vector3.new(-0, -0, -50)

username.MeshPartAccessory.Handle.AlignPosition.Attachment0 = username.MeshPartAccessory.Handle.Attachment
username.MeshPartAccessory.Handle.AlignPosition.Attachment1 = username.Model2.Part1.Attachment
username.MeshPartAccessory.Handle.AlignOrientation.Attachment0 = username.MeshPartAccessory.Handle.Attachment
username.MeshPartAccessory.Handle.AlignOrientation.Attachment1 = username.Model2.Part1.Attachment
